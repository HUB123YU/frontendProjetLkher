...
@Component({
  selector: 'app-register-encadrantinterne',
  templateUrl: './register-encadrantinterne.component.html',
  styleUrls: ['./register-encadrantinterne.component.css']
})
export class RegisterEncadrantinterneComponent implements OnInit {
