...
@Component({
  selector: 'app-domaine-view-admin',
  templateUrl: './domaine-view-admin.component.html'
})
export class DomaineViewAdminComponent implements OnInit {
    ...
    constructor(private service: DomaineAdminService){
