...
@Component({
  selector: 'app-secteur-activite-create-admin',
  templateUrl: './secteur-activite-create-admin.component.html'
})
export class SecteurActiviteCreateAdminComponent  implements OnInit {
