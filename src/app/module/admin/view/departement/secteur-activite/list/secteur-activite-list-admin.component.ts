...
@Component({
  selector: 'app-secteur-activite-list-admin',
  templateUrl: './secteur-activite-list-admin.component.html'
})
export class SecteurActiviteListAdminComponent implements OnInit {
