                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: DomaineListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: FiliereListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: SecteurActiviteListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class DepartementAdminRoutingModule { }
