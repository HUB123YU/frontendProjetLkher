...
@Component({
  selector: 'app-attachement-create-admin',
  templateUrl: './attachement-create-admin.component.html'
})
export class AttachementCreateAdminComponent  implements OnInit {
    ...
    const isPermistted = await this.roleService.isPermitted('TypeAttachement', 'add');
    if(isPermistted) {
