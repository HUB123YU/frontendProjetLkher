...
@Component({
  selector: 'app-type-attachement-view-admin',
  templateUrl: './type-attachement-view-admin.component.html'
})
export class TypeAttachementViewAdminComponent implements OnInit {
    ...
    constructor(private service: TypeAttachementAdminService){
