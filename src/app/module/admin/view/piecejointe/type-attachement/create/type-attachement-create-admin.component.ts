...
@Component({
  selector: 'app-type-attachement-create-admin',
  templateUrl: './type-attachement-create-admin.component.html'
})
export class TypeAttachementCreateAdminComponent  implements OnInit {
