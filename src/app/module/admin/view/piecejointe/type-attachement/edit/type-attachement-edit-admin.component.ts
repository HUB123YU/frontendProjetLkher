...
@Component({
  selector: 'app-type-attachement-edit-admin',
  templateUrl: './type-attachement-edit-admin.component.html'
})
export class TypeAttachementEditAdminComponent implements OnInit {
