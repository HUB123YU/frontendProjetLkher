...
@Component({
  selector: 'app-genre-view-admin',
  templateUrl: './genre-view-admin.component.html'
})
export class GenreViewAdminComponent implements OnInit {
    ...
    constructor(private service: GenreAdminService){
