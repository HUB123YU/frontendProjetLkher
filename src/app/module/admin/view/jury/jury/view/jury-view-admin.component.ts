...
@Component({
  selector: 'app-jury-view-admin',
  templateUrl: './jury-view-admin.component.html'
})
export class JuryViewAdminComponent implements OnInit {
    ...
    constructor(private service: JuryAdminService, private encadrantInterneService: EncadrantInterneAdminService, private juryEncadrantInterneService: JuryEncadrantInterneAdminService){
