...
import {VilleAdminService} from 'src/app/shared/service/admin/appartenance/VilleAdmin.service';
import {PaysDto} from 'src/app/shared/model/appartenance/Pays.model';
import {PaysAdminService} from 'src/app/shared/service/admin/appartenance/PaysAdmin.service';
...
export class SocieteListAdminComponent implements OnInit {

    protected fileName = 'Societe';
    ...
    secteurActivites: Array<SecteurActiviteDto>;
    payss: Array<PaysDto>;


    constructor( private service: SocieteAdminService  , private secteurActiviteService: SecteurActiviteAdminService, private villeService: VilleAdminService, private paysService: PaysAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SocieteDto>();
    ...
    public async edit(dto: SocieteDto) {
    ...
    public async view(dto: SocieteDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SocieteDto) {
    ...
    public async duplicate(dto: SocieteDto) {
    ...
    public exportPdf(dto: SocieteDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'secteurActivite?.libelle', header: 'Secteur activite'},
    ...
    public async loadSecteurActivite(){
        this.secteurActiviteService.findAllOptimized().subscribe(secteurActivites => this.secteurActivites = secteurActivites, error => console.log(error))
    }
    public async loadPays(){
        this.paysService.findAllOptimized().subscribe(payss => this.payss = payss, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Secteur activite': e.secteurActivite?.libelle ,
                 'Email': e.email ,
        ...
        this.criteriaData = [{
            ...
            'Fax': this.criteria.fax ? this.criteria.fax : environment.emptyForExport ,
            'Domaine': this.criteria.domaine ? this.criteria.domaine : environment.emptyForExport ,
        //'Ville': this.criteria.ville?.libelle ? this.criteria.ville?.libelle : environment.emptyForExport ,
        //'Secteur activite': this.criteria.secteurActivite?.libelle ? this.criteria.secteurActivite?.libelle : environment.emptyForExport ,
            'Email': this.criteria.email ? this.criteria.email : environment.emptyForExport ,
            'Telephone': this.criteria.telephone ? this.criteria.telephone : environment.emptyForExport ,
            'Code postal': this.criteria.codePostal ? this.criteria.codePostal : environment.emptyForExport ,
        //'Pays': this.criteria.pays?.libelle ? this.criteria.pays?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<SocieteDto> {
        return this.service.selections;
    }

    set selections(value: Array<SocieteDto>) {
