...
export class SocieteViewAdminComponent implements OnInit {
    ...
    constructor(private service: SocieteAdminService, private secteurActiviteService: SecteurActiviteAdminService, private villeService: VilleAdminService, private paysService: PaysAdminService){
