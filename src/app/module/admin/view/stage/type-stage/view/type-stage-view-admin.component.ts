...
@Component({
  selector: 'app-type-stage-view-admin',
  templateUrl: './type-stage-view-admin.component.html'
})
export class TypeStageViewAdminComponent implements OnInit {
    ...
    constructor(private service: TypeStageAdminService){
