            ...
            [
                {
                    ...
                    children: [
...

                        {
                            ...
                            path: 'stage-attachement',
                            children: [
                                {
                                    path: 'list',
                                    component: StageAttachementListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: TypeStageListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: StageListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class StageAdminRoutingModule { }
