...
@Component({
  selector: 'app-stage-attachement-create-admin',
  templateUrl: './stage-attachement-create-admin.component.html'
})
export class StageAttachementCreateAdminComponent  implements OnInit {
