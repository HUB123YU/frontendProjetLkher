...
@Component({
  selector: 'app-stage-attachement-list-admin',
  templateUrl: './stage-attachement-list-admin.component.html'
})
export class StageAttachementListAdminComponent implements OnInit {
