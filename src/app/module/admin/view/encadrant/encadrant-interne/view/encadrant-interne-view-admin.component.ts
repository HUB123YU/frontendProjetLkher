...
@Component({
  selector: 'app-encadrant-interne-view-admin',
  templateUrl: './encadrant-interne-view-admin.component.html'
})
export class EncadrantInterneViewAdminComponent implements OnInit {
    ...
    constructor(private service: EncadrantInterneAdminService){
