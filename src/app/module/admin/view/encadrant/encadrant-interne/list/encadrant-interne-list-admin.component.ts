...
@Component({
  selector: 'app-encadrant-interne-list-admin',
  templateUrl: './encadrant-interne-list-admin.component.html'
})
export class EncadrantInterneListAdminComponent implements OnInit {
