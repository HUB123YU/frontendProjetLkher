...
@Component({
  selector: 'app-encadrant-externe-create-admin',
  templateUrl: './encadrant-externe-create-admin.component.html'
})
export class EncadrantExterneCreateAdminComponent  implements OnInit {
