...
@Component({
  selector: 'app-encadrant-externe-edit-admin',
  templateUrl: './encadrant-externe-edit-admin.component.html'
})
export class EncadrantExterneEditAdminComponent implements OnInit {
