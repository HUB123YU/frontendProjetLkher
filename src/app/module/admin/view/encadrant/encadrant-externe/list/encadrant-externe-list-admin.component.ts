...
@Component({
  selector: 'app-encadrant-externe-list-admin',
  templateUrl: './encadrant-externe-list-admin.component.html'
})
export class EncadrantExterneListAdminComponent implements OnInit {

    protected fileName = 'EncadrantExterne';
    ...
    constructor( private service: EncadrantExterneAdminService  , private societeService: SocieteAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EncadrantExterneDto>();
    ...
    public async edit(dto: EncadrantExterneDto) {
    ...
    public async view(dto: EncadrantExterneDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EncadrantExterneDto) {
    ...
    public async duplicate(dto: EncadrantExterneDto) {
    ...
    public exportPdf(dto: EncadrantExterneDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'biographie', header: 'Biographie'},
	...
	public initDuplicate(res: EncadrantExterneDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            ...
            'Biographie': this.criteria.biographie ? this.criteria.biographie : environment.emptyForExport ,
    ...
    get selections(): Array<EncadrantExterneDto> {
        return this.service.selections;
    }

    set selections(value: Array<EncadrantExterneDto>) {
