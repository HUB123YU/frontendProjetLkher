...
@Component({
  selector: 'app-attachement-create-etudiant',
  templateUrl: './attachement-create-etudiant.component.html'
})
export class AttachementCreateEtudiantComponent  implements OnInit {
