...
@Component({
  selector: 'app-attachement-list-etudiant',
  templateUrl: './attachement-list-etudiant.component.html'
})
export class AttachementListEtudiantComponent implements OnInit {
