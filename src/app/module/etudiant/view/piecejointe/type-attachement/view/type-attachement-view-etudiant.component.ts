...
@Component({
  selector: 'app-type-attachement-view-etudiant',
  templateUrl: './type-attachement-view-etudiant.component.html'
})
export class TypeAttachementViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: TypeAttachementEtudiantService){
