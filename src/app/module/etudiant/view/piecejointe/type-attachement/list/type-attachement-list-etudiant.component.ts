...
@Component({
  selector: 'app-type-attachement-list-etudiant',
  templateUrl: './type-attachement-list-etudiant.component.html'
})
export class TypeAttachementListEtudiantComponent implements OnInit {
