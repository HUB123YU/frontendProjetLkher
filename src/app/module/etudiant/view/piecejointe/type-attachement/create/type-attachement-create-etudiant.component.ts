...
@Component({
  selector: 'app-type-attachement-create-etudiant',
  templateUrl: './type-attachement-create-etudiant.component.html'
})
export class TypeAttachementCreateEtudiantComponent  implements OnInit {
