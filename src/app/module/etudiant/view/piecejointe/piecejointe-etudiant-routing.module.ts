                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: AttachementListEtudiantComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            path: 'type-attachement',
                            children: [
                                {
                                    path: 'list',
                                    component: TypeAttachementListEtudiantComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class PiecejointeEtudiantRoutingModule { }
