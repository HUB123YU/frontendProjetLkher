            ...
            [
                {
                    ...
                    children: [
...

                        {
                            ...
                            path: 'encadrant-externe',
                            children: [
                                {
                                    path: 'list',
                                    component: EncadrantExterneListEtudiantComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            path: 'encadrant-interne',
                            children: [
                                {
                                    path: 'list',
                                    component: EncadrantInterneListEtudiantComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class EncadrantEtudiantRoutingModule { }
