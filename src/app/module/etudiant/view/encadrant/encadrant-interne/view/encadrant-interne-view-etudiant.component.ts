...
@Component({
  selector: 'app-encadrant-interne-view-etudiant',
  templateUrl: './encadrant-interne-view-etudiant.component.html'
})
export class EncadrantInterneViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: EncadrantInterneEtudiantService){
