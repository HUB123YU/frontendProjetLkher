...
@Component({
  selector: 'app-encadrant-interne-create-etudiant',
  templateUrl: './encadrant-interne-create-etudiant.component.html'
})
export class EncadrantInterneCreateEtudiantComponent  implements OnInit {
