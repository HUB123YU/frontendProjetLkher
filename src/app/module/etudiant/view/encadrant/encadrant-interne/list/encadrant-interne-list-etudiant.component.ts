...
@Component({
  selector: 'app-encadrant-interne-list-etudiant',
  templateUrl: './encadrant-interne-list-etudiant.component.html'
})
export class EncadrantInterneListEtudiantComponent implements OnInit {

    protected fileName = 'EncadrantInterne';
    ...
    constructor( private service: EncadrantInterneEtudiantService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EncadrantInterneDto>();
    ...
    public async edit(dto: EncadrantInterneDto) {
    ...
    public async view(dto: EncadrantInterneDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EncadrantInterneDto) {
    ...
    public async duplicate(dto: EncadrantInterneDto) {
    ...
    public exportPdf(dto: EncadrantInterneDto): void {
...
// add
	...
	public initDuplicate(res: EncadrantInterneDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<EncadrantInterneDto> {
        return this.service.selections;
    }

    set selections(value: Array<EncadrantInterneDto>) {
