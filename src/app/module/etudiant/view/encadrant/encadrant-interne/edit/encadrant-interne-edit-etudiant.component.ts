...
@Component({
  selector: 'app-encadrant-interne-edit-etudiant',
  templateUrl: './encadrant-interne-edit-etudiant.component.html'
})
export class EncadrantInterneEditEtudiantComponent implements OnInit {
