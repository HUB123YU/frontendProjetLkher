...
@Component({
  selector: 'app-encadrant-externe-list-etudiant',
  templateUrl: './encadrant-externe-list-etudiant.component.html'
})
export class EncadrantExterneListEtudiantComponent implements OnInit {
