...
@Component({
  selector: 'app-encadrant-externe-create-etudiant',
  templateUrl: './encadrant-externe-create-etudiant.component.html'
})
export class EncadrantExterneCreateEtudiantComponent  implements OnInit {
