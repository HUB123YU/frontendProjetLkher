...
@Component({
  selector: 'app-ville-view-etudiant',
  templateUrl: './ville-view-etudiant.component.html'
})
export class VilleViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: VilleEtudiantService){
