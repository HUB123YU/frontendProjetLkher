...
import {VilleCriteria} from 'src/app/shared/criteria/appartenance/VilleCriteria.model';
@Component({
  selector: 'app-ville-create-etudiant',
  templateUrl: './ville-create-etudiant.component.html'
})
export class VilleCreateEtudiantComponent  implements OnInit {
   ...
   private _validVilleLibelle = true;
	...
	constructor(private service: VilleEtudiantService , @Inject(PLATFORM_ID) private platformId? ) {
    ...
    public  setValidation(value: boolean){
        this.validVilleReference = value;
    ...
    public  validateForm(): void{
        ...
        this.validateVilleReference();
        this.validateVilleLibelle();
    }

    public validateVilleReference(){
        if (this.stringUtilService.isEmpty(this.item.reference)) {
        this.errorMessages.push('Reference non valide');
        this.validVilleReference = false;
        } else {
            this.validVilleReference = true;
        }
    }
