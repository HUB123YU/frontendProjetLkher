...
@Component({
  selector: 'app-nationalite-view-etudiant',
  templateUrl: './nationalite-view-etudiant.component.html'
})
export class NationaliteViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: NationaliteEtudiantService){
