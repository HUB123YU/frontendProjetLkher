...
@Component({
  selector: 'app-nationalite-edit-etudiant',
  templateUrl: './nationalite-edit-etudiant.component.html'
})
export class NationaliteEditEtudiantComponent implements OnInit {
