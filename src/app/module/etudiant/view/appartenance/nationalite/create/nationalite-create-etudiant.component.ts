...
@Component({
  selector: 'app-nationalite-create-etudiant',
  templateUrl: './nationalite-create-etudiant.component.html'
})
export class NationaliteCreateEtudiantComponent  implements OnInit {
