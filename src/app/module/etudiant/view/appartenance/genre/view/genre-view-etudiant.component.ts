...
@Component({
  selector: 'app-genre-view-etudiant',
  templateUrl: './genre-view-etudiant.component.html'
})
export class GenreViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: GenreEtudiantService){
