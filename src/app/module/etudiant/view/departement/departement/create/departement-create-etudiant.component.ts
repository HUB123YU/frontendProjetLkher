...
@Component({
  selector: 'app-departement-create-etudiant',
  templateUrl: './departement-create-etudiant.component.html'
})
export class DepartementCreateEtudiantComponent  implements OnInit {
