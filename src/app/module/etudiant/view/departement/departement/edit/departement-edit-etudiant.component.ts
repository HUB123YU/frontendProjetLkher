...
@Component({
  selector: 'app-departement-edit-etudiant',
  templateUrl: './departement-edit-etudiant.component.html'
})
export class DepartementEditEtudiantComponent implements OnInit {
