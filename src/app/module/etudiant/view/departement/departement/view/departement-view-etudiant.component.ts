...
@Component({
  selector: 'app-departement-view-etudiant',
  templateUrl: './departement-view-etudiant.component.html'
})
export class DepartementViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: DepartementEtudiantService){
