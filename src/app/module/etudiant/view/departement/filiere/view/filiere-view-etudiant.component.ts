...
@Component({
  selector: 'app-filiere-view-etudiant',
  templateUrl: './filiere-view-etudiant.component.html'
})
export class FiliereViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: FiliereEtudiantService, private departementService: DepartementEtudiantService){
