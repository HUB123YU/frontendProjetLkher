...
@Component({
  selector: 'app-domaine-view-etudiant',
  templateUrl: './domaine-view-etudiant.component.html'
})
export class DomaineViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: DomaineEtudiantService){
