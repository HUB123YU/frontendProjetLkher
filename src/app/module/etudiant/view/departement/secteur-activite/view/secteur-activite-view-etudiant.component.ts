...
@Component({
  selector: 'app-secteur-activite-view-etudiant',
  templateUrl: './secteur-activite-view-etudiant.component.html'
})
export class SecteurActiviteViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: SecteurActiviteEtudiantService){
