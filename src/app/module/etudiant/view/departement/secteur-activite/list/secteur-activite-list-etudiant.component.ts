...
@Component({
  selector: 'app-secteur-activite-list-etudiant',
  templateUrl: './secteur-activite-list-etudiant.component.html'
})
export class SecteurActiviteListEtudiantComponent implements OnInit {

    protected fileName = 'SecteurActivite';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SecteurActiviteDto>();
    ...
    public async edit(dto: SecteurActiviteDto) {
    ...
    public async view(dto: SecteurActiviteDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SecteurActiviteDto) {
    ...
    public async duplicate(dto: SecteurActiviteDto) {
    ...
    public exportPdf(dto: SecteurActiviteDto): void {
...
// add
	...
	public initDuplicate(res: SecteurActiviteDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<SecteurActiviteDto> {
        return this.service.selections;
    }

    set selections(value: Array<SecteurActiviteDto>) {
