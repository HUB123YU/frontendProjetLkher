...
@Component({
  selector: 'app-secteur-activite-edit-etudiant',
  templateUrl: './secteur-activite-edit-etudiant.component.html'
})
export class SecteurActiviteEditEtudiantComponent implements OnInit {
