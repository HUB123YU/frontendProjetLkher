...
@Component({
  selector: 'app-type-stage-create-etudiant',
  templateUrl: './type-stage-create-etudiant.component.html'
})
export class TypeStageCreateEtudiantComponent  implements OnInit {
