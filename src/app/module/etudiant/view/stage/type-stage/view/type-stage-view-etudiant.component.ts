...
@Component({
  selector: 'app-type-stage-view-etudiant',
  templateUrl: './type-stage-view-etudiant.component.html'
})
export class TypeStageViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: TypeStageEtudiantService){
