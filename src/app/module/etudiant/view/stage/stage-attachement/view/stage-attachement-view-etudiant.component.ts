...
@Component({
  selector: 'app-stage-attachement-view-etudiant',
  templateUrl: './stage-attachement-view-etudiant.component.html'
})
export class StageAttachementViewEtudiantComponent implements OnInit {
    ...
    constructor(private service: StageAttachementEtudiantService, private stageService: StageEtudiantService, private attachementService: AttachementEtudiantService){
