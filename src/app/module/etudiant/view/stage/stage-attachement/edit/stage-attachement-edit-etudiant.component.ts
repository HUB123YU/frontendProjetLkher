...
@Component({
  selector: 'app-stage-attachement-edit-etudiant',
  templateUrl: './stage-attachement-edit-etudiant.component.html'
})
export class StageAttachementEditEtudiantComponent implements OnInit {
