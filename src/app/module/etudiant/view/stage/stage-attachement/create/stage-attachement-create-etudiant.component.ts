...
@Component({
  selector: 'app-stage-attachement-create-etudiant',
  templateUrl: './stage-attachement-create-etudiant.component.html'
})
export class StageAttachementCreateEtudiantComponent  implements OnInit {
    ...
    const isPermistted = await this.roleService.isPermitted('Stage', 'add');
    if(isPermistted) {
