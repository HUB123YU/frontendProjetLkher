...
@Component({
  selector: 'app-jury-list-etudiant',
  templateUrl: './jury-list-etudiant.component.html'
})
export class JuryListEtudiantComponent implements OnInit {

    protected fileName = 'Jury';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<JuryDto>();
    ...
    public async delete(dto: JuryDto) {
    ...
    public async duplicate(dto: JuryDto) {
    ...
    public exportPdf(dto: JuryDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'nombreMembres', header: 'Nombre membres'},
        ];
    }
	...
	public initDuplicate(res: JuryDto) {
        if (res.juryEncadrantInternes != null) {
             res.juryEncadrantInternes.forEach(d => { d.jury = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Ref': e.ref ,
                 'Nombre membres': e.nombreMembres ,
            }
        });

        this.criteriaData = [{
            'Ref': this.criteria.ref ? this.criteria.ref : environment.emptyForExport ,
            'Nombre membres Min': this.criteria.nombreMembresMin ? this.criteria.nombreMembresMin : environment.emptyForExport ,
            'Nombre membres Max': this.criteria.nombreMembresMax ? this.criteria.nombreMembresMax : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<JuryDto> {
        return this.service.selections;
    }

    set selections(value: Array<JuryDto>) {
